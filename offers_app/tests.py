...
def _create_offer_with_details(
    owner,
    ...
    data = {
        ...
        "details": [
            ...
            },
            {
                ...
                "price": 500,
                "features": ["Logo", "Business Card", "Flyer"],
                "offer_type": "premium",
            },
        ],
    }
...
def test_other_user_cannot_edit_offer(api_client, business_user):
    ...
    Profile.objects.create(user=other_user, role=Profile.ROLE_BUSINESS)
...
@pytest.mark.django_db
def test_get_offers_filter_creator_id(
    api_client,
    business_user,
    other_business_user,
):
...
@pytest.mark.django_db
def test_offer_detail_returns_doku_fields(
    api_client,
    business_user,
    other_business_user,
):
